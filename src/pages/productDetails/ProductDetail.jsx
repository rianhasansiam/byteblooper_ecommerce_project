      ...
      <div className="flex flex-col lg:flex-row gap-8 xl:gap-12">
        ...
        <div className="lg:w-1/2">
          <div className="sticky top-4">
            {/* Main Image */}
            <div className="rounded-lg overflow-hidden mb-4 aspect-square bg-gray-100">
              <img 
            ...
            <div className="flex flex-wrap gap-2">
              {product.sizes.map(size => (
                <button
                  ...
                  className={`px-4 py-3 w-16 text-center border rounded-md text-sm font-medium transition-all ${
                    selectedSize === size
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center border border-gray-300 rounded-md">
                ...
                <span className="px-4 py-2 text-gray-900 border-x border-gray-300">{quantity}</span>
                <button 
            ...
            <button
              ...
              className="w-full py-4 px-4 bg-gray-900 hover:bg-gray-800 text-white font-medium rounded-md flex items-center justify-center gap-2 transition-colors"
            >
